...
class login extends Component {
    ...
    handleSubmit = (event) => {
        ...
        .then(res => {
            ...
            localStorage.setItem('FBIdToken' ,`Bearer ${res.data.token}`);      //store locally on user comp..if user switches to other tab
            this.setState({
                loading : false
            });
            ...
            <Grid container className = { classes.form }>
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit = {this.handleSubmit}>
                        ...
                        <br/><small>Don't have an account ? signup <Link to = "/signup">click here</Link></small>
                    </form>
